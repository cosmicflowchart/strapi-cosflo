...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pageLinks: Schema.Attribute.Component<'links.page-links', true>;
    publishedAt: Schema.Attribute.DateTime;
    socialLinks: Schema.Attribute.Component<'links.social-links', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    aboutMeText: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMaterialGroupMaterialGroup
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    materialVariants: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yardage: Schema.Attribute.String;
  };
}
...
export interface ApiMaterialVariantMaterialVariant
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    manufacturerNumber: Schema.Attribute.String;
    materialGroup: Schema.Attribute.Relation<
      'manyToOne',
      'api::material-group.material-group'
    >;
    name: Schema.Attribute.String;
...
export interface ApiProjectGroupProjectGroup
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    titleSingular: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
